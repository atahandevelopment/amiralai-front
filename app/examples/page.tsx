...
export default function Examples() {
  return (
    <main className="editorial-page">
      <p className="page-kicker">VERIFIED COMMAND FLOWS</p>
      <h1 className="page-title">Examples</h1>
      <div className="mt-10 space-y-5">
        <section className="doc-card">
          <h2 className="card-title">Review before execution</h2>
        ...
        <section className="doc-card">
          <h2 className="card-title">Plan and execute together</h2>
          <pre className="command mt-4">
        ...
        <section className="doc-card">
          <h2 className="card-title">Inspect and resume</h2>
          <pre className="command mt-4">
            <code>
        ...
        <section className="doc-card">
          <h2 className="card-title">Recover a failed task</h2>
          <pre className="command mt-4">
            <code>
